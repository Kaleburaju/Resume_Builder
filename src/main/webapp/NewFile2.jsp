...
<body> <nav>
    ...
    <i class="fa fa-bars"></i>
       ...
       <ul>
            ...
            <li><a class="active" href="http://localhost:8080/Resume/selectresume.jsp">Back</a></li>
        </ul><hr>
    </nav> 
...
<div class="container">
    <div id="inputFields">
        ...
        <form id="userInputForm" action="NextFileServlet" method="post">
            ...
            <textarea id="certificate" name="certificate" rows="2" required  autocomplete="off"></textarea><br> 
