...
public class NextFileDb {
    ...
    public String insertUser(NextFilebean sb) {
        ...
        if (con != null) {
            ...
            try {
                // Insert the new user
                pstmt = con.prepareStatement("INSERT INTO resumedata (name, resumedatacol, about, follow, education, skills, interests, certificate) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
                ...
                if (rowsInserted > 0) {
                    ...
                    result = "Failed to register user22";
                }
